    ...
    return (
        ...
        <div className="homeUpper">
            <section className='home'>
                <div className='left'>
                    <h1>Food Recipe</h1>
                     <h5>Discover a wide variety of delicious recipes crafted to inspire your cooking journey. Save your personal favorites, explore new flavors from around the world, and enjoy step-by-step guidance that makes cooking simple, fun, and rewarding. </h5>
